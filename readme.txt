...
1. Please install plugin "MainWP Dashboard" and active it before install MainWP Development Extension plugin (get the MainWP Dashboard plugin from url:https://mainwp.com/)
2. Upload the `mainwp-development-extension` folder to the `/wp-content/plugins/` directory
3. Activate the MainWP Development Extension plugin through the 'Plugins' menu in WordPress
